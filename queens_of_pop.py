...
artist_names = [
    ...
    "Lorde", "Shakira", "Sugarland", "Aaliyah", "Céline Dion", "The Pussycat Dolls", "Sabrina Carpenter",
    ...
    "Jessica Simpson", "Shania Twain", "Eve", "Natasha Bedingfield", "Whitney Houston", "Iggy Azalea", "Lana Del Rey",
    "Amy Winehouse", "Hilary Duff", "Gretchen Wilson", "Carly Rae Jepsen", "Susan Boyle", "Jordin Sparks",
    "Ashlee Simpson", "Martina McBride", "Chappell Roan", "Fleetwood Mac", "The Band Perry", "Michelle Branch",
    "Alessia Cara", "Summer Walker", "Reba McEntire", "Keri Hilson", "Barbra Streisand", "Mya", "Bebe Rexha",
    "Paramore", "Lil' Kim", "Brenda Lee", "Toni Braxton", "Charli XCX", "Sade", "Fifth Harmony", "Fantasia",
    "Vanessa Carlton", "Danity Kane"
]
...
optimal_k = 12  # This will depend on your analysis
...
# Get the top 3 genres for each cluster (genres with the highest sums)
top_genres = cluster_genres.apply(lambda x: x.nlargest(3).index.tolist(), axis=1)
...
cluster_summary.columns = ['Avg Ranking', 'Avg Followers', 'Avg Popularity', 'Top 3 Genres']
